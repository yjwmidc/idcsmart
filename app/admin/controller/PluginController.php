...
class PluginController extends AdminBaseController
{
     ...
     * @return int count - 总数
     */
    public function certificationPluginList(): Json
    {
     ...
     */
    public function certificationInstall(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'certification';
     ...
     * @param string name - 标识 required
     */
    public function certificationUninstall(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'certification';
     ...
     */
    public function certificationStatus(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'certification';
     ...
     */
    public function certificationSetting(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'certification';
     ...
     */
    public function certificationSettingPost(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'certification';
     ...
     * @return int count - 总数
     */
    public function captchaPluginList(): Json
    {
        $param = $this->request->param();
     ...
     * @param string name - 标识 required
     */
    public function captchaInstall(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'captcha';
     ...
     * @param string name - 标识 required
     */
    public function captchaUninstall(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'captcha';
     ...
     * @param string status - 状态:1启用,0禁用 required
     */
    public function captchaStatus(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'captcha';
     ...
     * @return string plugin.config[].field - 配置字段名,保存时传的键
     */
    public function captchaSetting(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'captcha';
     ...
     * @param array config.field - 配置:field为返回的配置字段 required
     */
    public function captchaSettingPost(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'captcha';
     ...
     * @return int count - 总数
     */
    public function oauthPluginList(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'oauth';
     ...
     * @param string name - 标识 required
     */
    public function oauthInstall(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'oauth';
     ...
     * @param string name - 标识 required
     */
    public function oauthUninstall(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'oauth';
     ...
     * @param string status - 状态:1启用,0禁用 required
     */
    public function oauthStatus(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'oauth';
     ...
     * @return string plugin.config[].field - 配置字段名,保存时传的键
     */
    public function oauthSetting(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'oauth';
     ...
     * @param array config.field - 配置:field为返回的配置字段 required
     */
    public function oauthSettingPost(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'oauth';
     ...
     * @return int count - 总数
     */
    public function smsPluginList(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'sms';
     ...
     * @param string name - 标识 required
     */
    public function smsInstall(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'sms';
     ...
     * @param string name - 标识 required
     */
    public function smsUninstall(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'sms';
     ...
     * @param string status - 状态:1启用,0禁用 required
     */
    public function smsStatus(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'sms';
     ...
     * @return string plugin.config[].field - 配置字段名,保存时传的键
     */
    public function smsSetting(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'sms';
     ...
     * @param array config.field - 配置:field为返回的配置字段 required
     */
    public function smsSettingPost(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'sms';
     ...
     * @param array config.field - 配置:field为返回的配置字段 required
     */
    public function smsPullSign(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'sms';
     ...
     * @return int count - 总数
     */
    public function mailPluginList(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'mail';
     ...
     * @param string name - 标识 required
     */
    public function mailInstall(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'mail';
     ...
     * @param string name - 标识 required
     */
    public function mailUninstall(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'mail';
     ...
     * @param string status - 状态:1启用,0禁用 required
     */
    public function mailStatus(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'mail';
     ...
     * @return string plugin.config[].field - 配置字段名,保存时传的键
     */
    public function mailSetting(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'mail';
     ...
     * @param array config.field - 配置:field为返回的配置字段 required
     */
    public function mailSettingPost(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'mail';
     ...
     * @return int count - 总数
     */
    public function gatewayPluginList(): Json
    {
        $param = $this->request->param();
     ...
     * @param string name - 标识 required
     */
    public function gatewayInstall(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'gateway';
     ...
     * @param string name - 标识 required
     */
    public function gatewayUninstall(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'gateway';
     ...
     * @param string status - 状态:1启用,0禁用 required
     */
    public function gatewayStatus(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'gateway';
     ...
     * @return string plugin.config[].field - 配置字段名,保存时传的键
     */
    public function gatewaySetting(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'gateway';
     ...
     * @param array config.field - 配置:field为返回的配置字段 required
     */
    public function gatewaySettingPost(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'gateway';
     ...
     * @return int count - 总数
     */
    public function addonPluginList(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'addon';
     ...
     * @param string name - 标识 required
     */
    public function addonInstall(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'addon';
     ...
     * @param string name - 标识 required
     */
    public function addonUninstall(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'addon';
     ...
     * @param string status - 状态:1启用,0禁用 required
     */
    public function addonStatus(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'addon';
     ...
     * @return int count - 总数
     */
    public function ossPluginList(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'oss';
     ...
     * @param string name - 标识 required
     */
    public function ossInstall(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'oss';
     ...
     * @param string name - 标识 required
     */
    public function ossUninstall(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'oss';
     ...
     * @return string plugin.config[].field - 配置字段名,保存时传的键
     */
    public function ossSetting(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'oss';
     ...
     * @param array config.field - 配置:field为返回的配置字段 required
     */
    public function ossSettingPost(): Json
    {
        $param = $this->request->param();
        $param['module'] = 'oss';
     ...
     */
    public function templateUninstall(): Json
    {
        $param = $this->request->param();
     ...
     */
    public function pluginHookList(): Json
    {
        $param = $this->request->param();
     ...
     */
    public function pluginHookOrder(): Json
    {
        $param = $this->request->param();
     ...
     * @param array id - 插件ID数组 required
     */
    public function gatewayPluginOrder(): Json
    {
        $param = $this->request->param();
