...
{   
     ...
     * @method  GET
     * @param string keywords - 关键字,搜索范围:描述,IP
     * @param int begin_time - 搜索开始时间戳
     * @param int end_time - 搜索结束时间戳
     * @param int admin_name - 操作人
     ...
     */
	public function systemLogList(): json
    {
		// 合并分页参数
     ...
     * @method  GET
     * @param string keywords - 关键字,搜索范围:内容,邮箱
     * @param int client_id - 用户ID
     * @param int page - 页数
     * @param int limit - 每页条数
     * @param string orderby - 排序 id
     ...
     */
    public function emailLogList(): json
    {
        // 合并分页参数
        $param = array_merge($this->request->param(), ['page' => $this->request->page, 'limit' => $this->request->limit, 'sort' => $this->request->sort]);
     ...
     * @method  GET
     * @param string keywords - 关键字,搜索范围:内容,手机号
     * @param int client_id - 用户ID
     * @param int page - 页数
     * @param int limit - 每页条数
     * @param string orderby - 排序 id
     ...
     */
    public function smsLogList(): json
    {
        // 合并分页参数
        $param = array_merge($this->request->param(), ['page' => $this->request->page, 'limit' => $this->request->limit, 'sort' => $this->request->sort]);
