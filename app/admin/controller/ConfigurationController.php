...
class ConfigurationController extends AdminBaseController
{
     ...
     */
    public function systemList(): Json
    {
		//实例化模型类
     ...
     */
    public function systemUpdate(): Json
    {
		//接收参数
     ...
     * @return  int register_phone - 是否允许手机号注册:1开启0关闭
     ...
     * @return  string admin_login_ip_whitelist - 后台登录IP白名单,换行分隔,空表示不限制
     */
     ...
     * @param  string first_login_method - 账户凭证首选登录方式(code=验证码,password=密码)
     ...
     * @param  string admin_login_ip_whitelist - 后台登录IP白名单,换行分隔,空表示不限制
     */
    public function loginUpdate(): Json
    {
		//接收参数
		$param = $this->request->param();
     ...
     */
    public function securityCaptcha(): Json
    {
		//接收参数
		$param = $this->request->param();
		$config = [
     ...
     */
    public function securityList(): Json
    {
		//实例化模型类
		$ConfigurationModel = new ConfigurationModel();
     ...
     */
    public function securityUpdate(): Json
    {
		//接收参数
		$param = $this->request->param();
     ...
     */
    public function currencyList(): Json
    {
		//实例化模型类
		$ConfigurationModel = new ConfigurationModel();
     ...
     */
    public function currencyUpdate(): Json
    {
		//接收参数
		$param = $this->request->param();
     ...
     */
    public function cronUpdate(): Json
    {
		//接收参数
		$param = $this->request->param();
     ...
     */
    public function themeList(): Json
    {
        //实例化模型类
        $ConfigurationModel = new ConfigurationModel();
     ...
     * @param string home_theme - 首页PC主题
     * @param string home_theme_mobile - 首页手机主题
     * @param array home_host_theme - 会员中心产品详情PC主题,键值对,键是模块标识,值是主题
     * @param array home_host_theme_mobile - 会员中心产品详情手机主题,键值对,键是模块标识,值是主题
     */
    public function themeUpdate(): Json
    {
        //接收参数
        $param = $this->request->param();
     ...
     */
    public function certificationList(): Json
    {
        //实例化模型类
        $ConfigurationModel = new ConfigurationModel();
     ...
     */
    public function certificationUpdate(): Json
    {
        //接收参数
        $param = $this->request->param();
     ...
     */
    public function infoUpdate(): Json
    {
        //接收参数
        $param = $this->request->param();
     ...
     */
    public function debugInfo(): Json
    {
        //实例化模型类
        $ConfigurationModel = new ConfigurationModel();
     ...
     */
    public function getOssConfig(): Json
    {
        //实例化模型类
        $ConfigurationModel = new ConfigurationModel();
     ...
     */
    public function ossConfig(): Json
    {
        //接收参数
        $param = $this->request->param();
     ...
     * @param string official_website_logo - 官网LOGO required
     */
    public function webUpdate(): Json
    {
        //接收参数
        $param = $this->request->param();
     ...
     */
    public function cloudServerList(): Json
    {
        //实例化模型类
        $ConfigurationModel = new ConfigurationModel();
     ...
     */
    public function cloudServerUpdate(): Json
    {
        //接收参数
        $param = $this->request->param();
     ...
     */
    public function physicalServerList(): Json
    {
        //实例化模型类
        $ConfigurationModel = new ConfigurationModel();
     ...
     */
    public function physicalServerUpdate(): Json
    {
        //接收参数
        $param = $this->request->param();
     ...
     */
    public function icpUpdate(): Json
    {
        //接收参数
        $param = $this->request->param();
     ...
     */
    public function productGlobalSetting(): Json
    {
        //实例化模型类
        $ConfigurationModel = new ConfigurationModel();
     ...
     * @version v1
     */
    public function productGlobalSettingUpdate(): Json
    {
        //接收参数
        $param = $this->request->param();
     ...
     * @version v1
     */
    public function touristVisibleProduct(): Json
    {
        //实例化模型类
        $ConfigurationModel = new ConfigurationModel();
     ...
     * @version v1
     */
    public function touristVisibleProductUpdate(): Json
    {
        $param = $this->request->param();
     ...
     */
    public function supplierCreditWarning(): Json
    {
        //实例化模型类
        $ConfigurationModel = new ConfigurationModel();
     ...
     * @version v1
     */
    public function supplierCreditWarningUpdate(): Json
    {
        //接收参数
        $param = $this->request->param();
     ...
     */
    public function globalOnDemand(): Json
    {
        //实例化模型类
        $ConfigurationModel = new ConfigurationModel();
     ...
     * @version v1
     */
    public function globalOnDemandUpdate(): Json
    {
        //接收参数
        $param = $this->request->param();
