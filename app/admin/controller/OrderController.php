...
class OrderController extends AdminBaseController
{
     ...
     * @param  int start_pay_time - 搜索:开始支付时间
     * @param  int end_pay_time - 搜索:结束支付时间
     ...
     * @return string list[].order_invoice_status - 开票状态(显示字段有order_invoice_status返回)
     ...
     */
    public function getUpgradeAmount(): Json
    {
        // 接收参数
        $param = $this->request->param();
     ...
     */
	public function updateAmount(): Json
    {
		// 接收参数
        $param = $this->request->param();
     ...
     * @param string description - 描述 required
     */
    public function updateOrderItem(): Json
    {
        // 接收参数
        $param = $this->request->param();
     ...
     * @param int id - 订单子项ID required
     */
    public function deleteOrderItem(): Json
    {
        // 接收参数
        $param = $this->request->param();
     ...
     */
    public function orderRefund(): Json
    {
        // 接收参数
        $param = $this->request->param();
     ...
     */
    public function orderApplyCredit(): Json
    {
        // 接收参数
        $param = $this->request->param();
     ...
     * @param float amount - 金额 required
     */
    public function orderRemoveCredit(): Json
    {
        // 接收参数
        $param = $this->request->param();
     ...
     */
    public function refundRecordList(): Json
    {
        // 合并分页参数
        $param = array_merge($this->request->param(), ['page' => $this->request->page, 'limit' => $this->request->limit, 'sort' => $this->request->sort]);
     ...
     */
    public function deleteRefundRecord(): Json
    {
        // 接收参数
        $param = $this->request->param();
     ...
     * @param int id - 退款记录ID required
     */
    public function pendingRefundRecord(): Json
    {
        // 接收参数
        $param = $this->request->param();
     ...
     */
    public function rejectRefundRecord(): Json
    {
        // 接收参数
        $param = $this->request->param();
     ...
     */
    public function redundedRefundRecord(): Json
    {
        // 接收参数
        $param = $this->request->param();
     ...
     */
    public function updateGateway(): Json
    {
        // 接收参数
        $param = $this->request->param();
     ...
     * @param string notes - 备注
     */
    public function updateNotes(): Json
    {
        // 接收参数
        $param = $this->request->param();
     ...
     */
    public function moduleClientConfigOption(): Json
    {
        $param = $this->request->param();
     ...
     */
    public function getOrderRecycleBinConfig(): Json
    {
     ...
     * @version v1
     */
    public function enableOrderRecycleBin(): Json
    {
        $ConfigurationModel = new ConfigurationModel();
     ...
     */
    public function orderRecycleBinConfigUpdate(): Json
    {
        $param = $this->request->param();
     ...
     * @return int count - 订单总数
     */
    public function recycleBinOrderList(): Json
    {
        $param = array_merge($this->request->param(), ['page' => $this->request->page, 'limit' => $this->request->limit, 'sort' => $this->request->sort]);
     ...
     */
    public function recoverOrder(): Json
    {
        $param = $this->request->param();
     ...
     * @param   array id - 订单ID require
     */
    public function deleteOrderFromRecycleBin(): Json
    {
        $param = $this->request->param();
        $param['delete_host'] = 1;
     ...
     * @version v1
     */
    public function clearRecycleBin(): Json
    {
        $OrderModel = new OrderModel();
     ...
     * @param   array id - 订单ID require
     */
    public function unlockOrder(): Json
    {
        $param = $this->request->param();
     ...
     */
    public function uploadOrderVoucher(): Json
    {
        $param = $this->request->param();
     ...
     */
    public function reviewOrder(): Json
    {
        $param = $this->request->param();
     ...
     */
    public function orderHostRefundList(): Json
    {
        $param = $this->request->param();
     ...
     */
    public function orderRefundIndex(): Json
    {
        $param = $this->request->param();
