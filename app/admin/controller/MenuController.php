...
class MenuController extends AdminBaseController
{
     ...
     */
    public function getHomeMenu(): json
    {
        // 实例化模型类
        $MenuModel = new MenuModel();
     ...
     */
    public function saveAdminMenu(): json
    {
        // 接收参数
     ...
     */
    public function saveHomeMenu(): json
    {
        // 接收参数
        $param = $this->request->param();
     ...
     * @return string show_name - 图标显示名称
     * @return string icon_uri - 图标资源地址
     */
    public function customHomeMenuIcon(): json
    {
        $param = $this->request->param();
