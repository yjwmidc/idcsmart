...
//    }
     ...
     * @return int count - 总数
     */
    public function captchaList(): Json
    {
        $result = [
            'status'=>200,
            'msg'=>lang('success_message'),
...
-----END PUBLIC KEY-----";
     ...
     */
    public function countryList(): Json
    {
        // 接收参数
        $param = $this->request->param();
     ...
     */
    public function adminAuthList(): Json
    {
        $result = [
            'status' => 200,
            'msg' => lang('success_message'),
     ...
     */
    public function adminMenu(): Json
    {
        $result = [
            'status' => 200,
            'msg' => lang('success_message'),
     ...
     */
    public function globalSearch(): Json
    {
        // 接收参数
        $param = $this->request->param();
     ...
     */
    public function activePluginList(): Json
    {
        $param = $this->request->param();
     ...
     */
    public function clientareaAuthList(): Json
    {
        $result = [
            'status' => 200,
            'msg' => lang('success_message'),
     ...
     */
    public function commonSearchTableList(): Json
    {
        $lang = lang();
     ...
     */
    public function commonSearch(): Json
    {
        // 合并分页参数
     ...
     */
    public function adminViewIndex(): Json
    {
        $param = $this->request->param();
     ...
     */
    public function adminViewDataRange(): Json
    {
        $param = $this->request->param();
     ...
     */
    public function adminViewList(): Json
    {
        $param = $this->request->param();
     ...
     */
    public function chooseAdminView(): Json
    {
        $param = $this->request->param();
     ...
     */
    public function createAdminView(): Json
    {
        $param = $this->request->param();
     ...
     * @param   int select_data_range[].value.day2 动态时间2,数据范围为date时,规则为dynamic时,condition2不为now时必传
     */
    public function updateAdminView(): Json
    {
        $param = $this->request->param();
        $param['admin_id'] = get_admin_id();
     ...
     * @param   array select_field - 选定字段标识 require
     */
    public function updateAdminViewField(): Json
    {
     ...
     * @param   int select_data_range[].value.day2 动态时间2,数据范围为date时,规则为dynamic时,condition2不为now时必传
     */
    public function updateAdminViewDataRange(): Json
    {
     ...
     * @param   int id - 视图ID require
     */
    public function deleteAdminView(): Json
    {
        $param = $this->request->param();
     ...
     * @param   int id - 视图ID require
     */
    public function copyAdminView(): Json
    {
        $param = $this->request->param();
     ...
     */
    public function statusAdminView(): Json
    {
        $param = $this->request->param();
     ...
     * @param   string view - 页面标识(client=用户管理,order=订单管理,host=产品管理,transaction=交易流水) require
     */
    public function orderAdminView(): Json
    {
        $param = $this->request->param();
     ...
     * @return string list[].url - 地址
     */
    public function templateTabList(): Json
    {
        $param = $this->request->param();
     ...
     */
    public function sendParam(): Json
    {
        $defaultParam = [
            'system' => [
                'system_website_name',
