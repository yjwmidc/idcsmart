...
class ConfigurationValidate extends Validate
{
  ...
  //       'dcim_product_link.url' => 'dcim_product_link_error',
    ...
    protected $scene = [
        'system_update' => ['lang_admin','lang_home_open','lang_home','maintenance_mode','website_name','website_url','terms_service_url','terms_privacy_url','system_logo','client_start_id_value','order_start_id_value','clientarea_url','home_show_deleted_host','clientarea_logo_url','clientarea_logo_url_blank','global_list_limit'],
        'login_update' => ['register_email','register_phone','login_phone_verify','home_login_check_ip','admin_login_check_ip','code_client_phone_register','code_client_phone_register','home_login_check_common_ip','home_login_ip_exception_verify','home_enforce_safe_method','admin_enforce_safe_method','admin_allow_remember_account','admin_enforce_safe_method_scene','login_email_password','admin_second_verify','admin_second_verify_method_default','prohibit_admin_bind_phone','prohibit_admin_bind_email','admin_password_or_verify_code_retry_times','admin_frozen_time','admin_login_expire_time','login_phone_password','home_login_expire_time'],
        'security_update' => ['captcha_client_register','captcha_client_login','captcha_client_login_error','captcha_admin_login','captcha_client_verify','captcha_client_update','captcha_client_password_reset','captcha_client_oauth','captcha_admin_login_error'],
