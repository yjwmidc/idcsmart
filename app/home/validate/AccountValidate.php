...
class AccountValidate extends Validate
{
	...
	protected $rule = [
        ...
        'warning_switch'            => 'require|in:0,1',
        'leave_percent'             => 'requireIf:warning_switch,1|in:0,5,10,15,20',
        'credit_remind'             => 'require|in:0,1',
        'credit_remind_amount'      => 'require|egt:0',
    ];
    ...
    protected $message  =   [
        ...
        'warning_switch.require'        => 'param_error',
        'warning_switch.in'             => 'param_error',
        'leave_percent.requireIf'       => 'param_error',
        'leave_percent.in'              => 'param_error',
        'credit_remind.require'         => 'param_error',
        'credit_remind.in'              => 'param_error',
        'credit_remind_amount.require'  => 'param_error',
        'credit_remind_amount.egt'      => 'credit_remind_amount_egt_0',
    ];
    ...
    protected $scene = [
        ...
        'update_traffic_warning' => ['warning_switch','leave_percent'],
        'credit_remind' => ['credit_remind','credit_remind_amount'],
    ];
}