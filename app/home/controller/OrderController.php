...
class OrderController extends HomeBaseController
{
     ...
     * @param string sort - 升/降序 asc,desc
     */
    public function exportExcel(): Json
    {
        // 合并分页参数
        $param = array_merge($this->request->param(), ['page' => $this->request->page, 'limit' => $this->request->limit, 'sort' => $this->request->sort]);
     ...
     */
    public function submitApplication(): Json
    {
        $param = $this->request->param();
     ...
     * @param   int id - 订单ID require
     */
    public function changeGateway(): Json
    {
        $param = $this->request->param();
     ...
     * @return  string list[].amount - 金额
     */
    public function orderTransactionRecord(): Json
    {
        $param = $this->request->param();
     ...
     * @method POST
     * @param  array ids - 订单ID,数组 required
     * @return int id - 合并后的订单ID
     * @return string amount - 合并后的订单金额
     */
    public function combineOnDemandOrder(): Json
    {
        $param = $this->request->param();
