...
class CommonController extends HomeBaseController
{
     ...
     * @return string telecom_appreciation - 增值电信 b1/b2
     ...
     * @return inf home_enforce_safe_method 前台强制安全选项
     * @return int login_email_password - 是否开启邮箱密码登录:1开启0关闭
     * @return int login_phone_password - 是否开启手机密码登录:1开启0关闭
     * @return string first_login_type - 首选登录方式(account_login=账户凭证登录,mp_weixin_notice=微信公众号登录)
     */
     ...
     */
    public function createFeedback(): Json
    {
        // 接收参数
        $param = $this->request->param();
     ...
     */
    public function createConsult(): Json
    {
        // 接收参数
        $param = $this->request->param();
