...
class HooksController
{
     ...
     * @author hh
     * @version v1
     * @param   HostModel host - 产品模型实例
     * @param   string module - 模块类型
     * @param   int start_time - 开始时间(秒级时间戳)
     * @param   int end_time - 结束时间(秒级时间戳)
     * @return  int status - 状态码(200=成功,400=失败)
     * @return  string msg - 提示信息
     * @return  float data.flow - 使用流量(单位:GB)
     * @return  bool data.support - 是否支持按需流量计费
     */
     ...
     * @param   bool is_admin - 是否管理员操作
     * @param   string gateway - 支付方式标识
     * @return  int status - 状态码(200=成功,400=失败)
     * @return  string msg - 提示信息
     */
     ...
     * @param   HostModel host - 产品模型实例
     * @param   string module - 模块类型
     * @param   string old_billing_cycle - 原计费方式
     * @param   string new_billing_cycle - 新计费方式
     * @return  int status - 状态码(200=成功,400=失败)
     * @return  string msg - 提示信息
     */
     ...
     * @version v1
     * @return  array
     * @return  string value - 首选方式标识
     * @return  string name - 首选方式名称
     */
     ...
     * @version v1
     * @return  array
     * @return  string label - 标签
     * @return  array param - 参数
     * @return  string param[].value - 值
     * @return  string param[].label - 标签
     */
