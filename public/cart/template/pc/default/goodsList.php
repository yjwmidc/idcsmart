          ...
          <div class="main-card">
            ...
            <div class="main-content-box">
              <div class="search-box">
                <div class="first-nav">
                  <div class="nav-name">{{commonData.first_navigation}}：</div>
                  <div class="nav-box">
                    <div class="nav-item" @click="selectFirstType(item.id)"
                      :class="{active:item.id==select_first_obj.id}" v-for="item in first_group_list" :key="item.id">
                      {{item.name}}
                    </div>
                  </div>
                </div>
                <div class="sec-nav" v-loading="secondLoading">
                  <div class="nav-name">{{commonData.second_navigation}}：</div>
                  <div class="nav-box">
                    <div class="nav-item" @click="selectSecondType(item.id)"
                      :class="{active:item.id==select_second_obj.id}" v-for="item in second_group_list" :key="item.id">
                      {{item.name}}
                    </div>
                  </div>
                </div>
