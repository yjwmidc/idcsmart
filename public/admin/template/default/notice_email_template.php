    ...
    <t-card class="list-card-container">
      <div class="common-header top">
        <div class="header-left">
          <div @click="jump" v-permission="'auth_system_interface_email_notice_email_template_create_template'">
            <t-button theme="primary">{{lang.create_template}}</t-button>
          </div>
          <t-button theme="default" @click="back" class="add com-gray-btn com-gap">{{lang.back}}</t-button>
        </div>
      </div>
