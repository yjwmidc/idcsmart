...
<div id="content" class="template template_host_config" v-cloak>
  <com-config>
    <t-card class="list-card-container">
      <div class="common-header top-tit">
        <h2 class="top-back com-first-title">{{lang.temp_controller}}
      ...
      <div class="box">
        <p class="s-tip third-text-color">{{lang.tem_tip10}}</p>
        <div class="content">
          <!-- 侧边栏 -->
          <div class="slider">
          ...
          <div class="con">
            ...
            <div class="banner-table" v-show="curValue === 'cloud' || curValue === 'dcim'">
              <div class="common-header">
                <div class="left first-text-color">{{lang.tem_banner}}</div>
            ...
            <div class="icp limit_table" v-if="curValue === 'icp'">
              <p class="first-text-color">{{lang.tem_tip11}}</p>
              <div class="host-id">
            ...
            <div class="common-header" :class="{ 'limit_table': curValue !== 'cloud' && curValue !== 'dcim'}">
              <div class="left first-text-color">{{calcTit}}</div>
              <div class="client-search">
                <t-button @click="handleBaseAdd">{{lang.tem_add}}</t-button>
                <t-button theme="default" class="com-gray-btn" @click="manageArea" v-if="showEditArea">{{lang.temp_edit_area}}</t-button>
              </div>
            </div>
            <!-- 基础表格 -->
            ...
            <div class="common-header more" :class="{ 'limit_table': curValue !== 'cloud' && curValue !== 'dcim'}">
              <div class="left first-text-color">
