...
return [
    ...
    'id_error' => 'ID错误',
    'param_error' => '参数错误',
    'balance_notice_show_closed' => '余额提醒功能已关闭，无法设置',
    ...
    'log_client_register' => '用户{account} 同意《服务协议》和《隐私协议》 ，账户注册成功',
    ...
    'credit_remind_amount_egt_0' => '余额提醒金额必须大于等于0',
    'client_phone_email_empty' => '请完善手机或邮箱信息',
    'credit_remind_send_email' => '余额提醒发送邮件',
    'credit_remind_send_sms' => '余额提醒发送短信',
    'credit_remind_update' => '用户{username}#{id}修改了会员中心余额提醒，是否开启：{credit_remind}，最低余额：{credit_remind_amount}',
];
