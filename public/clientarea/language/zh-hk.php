...
return [
    ...
    'id_error' => 'ID錯誤',
    'param_error' => '參數錯誤',
    'balance_notice_show_closed' => '餘額提醒功能已關閉，無法設置',
    ...
    'log_client_register' => '用戶{account} 同意《服務協議》和《隱私協議》 ，帳戶註冊成功',
    ...
    'credit_remind_amount_egt_0' => '餘額提醒金額必須大於等於0',
    'client_phone_email_empty' => '請完善手機或信箱資訊',
    'credit_remind_send_email' => '餘額提醒發送郵件',
    'credit_remind_send_sms' => '餘額提醒發送簡訊',
    'credit_remind_update' => '使用者{username}#{id}修改了會員中心餘額提醒，是否開啟：{credit_remind}，最低餘額：{credit_remind_amount}',
];
