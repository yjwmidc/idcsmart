...
class CertificationValidate extends Validate
{
    protected $rule = [
        ...
        'certification_show_certify_id'=> 'require|in:0,1',
        'reason'           => 'max:255',
    ];
    ...
    protected $message  =   [
        ...
        'reason.max'                 => 'certification_reject_reason_max',
    ];

    protected $scene = [
        'create_person' => ['plugin_name', 'card_name', 'card_type', 'card_number'],
        'create_company' => ['plugin_name', 'company', 'company_organ_code'],
        'set_config' => ['certification_open', 'certification_company_open','certification_approval', 'certification_notice' ,'certification_update_client_name','certification_upload', 'certification_update_client_phone', 'certification_uncertified_cannot_buy_product','certification_age','certification_age_open','certification_recharge','certification_show_certify_id'],
        'reject' => ['reason'],
    ];
