(function () {
  const plugin_lang = {
    "zh-cn": {
      ...
      realname_text85: "已支付",
      realname_text86: "文件大小不能超过3MB",
      realname_text87: "文件名不能包含 !@^&\"'/\\",
    },
    "en-us": {
      ...
      realname_text86: "File size cannot exceed 3MB",
      realname_text87: "Filenames cannot contain !@^&\"'/\\",
    },
    "zh-hk": {
      realname_text1: "實名認證",
      ...
      realname_text85: "已支付",
      realname_text86: "文件大小不能超過3MB",
      realname_text87: "檔案名稱不能包含 !@^&\"'/\\",
    },
  };
