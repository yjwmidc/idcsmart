...
class PromoCodeValidate extends Validate
{
	protected $rule = [
        ...
        'scene'               => 'require|in:new,upgrade,renew,change_billing_cycle',
        ...
        'on_demand_to_recurring_prepayment' => 'require|in:0,1',
    ];
    ...
    protected $message  =   [
        ...
        'on_demand_to_recurring_prepayment.require' => 'param_error',
        'on_demand_to_recurring_prepayment.in'      => 'param_error',
    ];

    protected $scene = [
        'create' => ['code','type','client_type','client_level','start_time','end_time','products','need_products','max_times','single_user_once','upgrade','host_upgrade','renew','loop','cycle_limit','cycle','notes','on_demand_to_recurring_prepayment'],
        'update' => ['id','client_type','client_level','start_time','end_time','products','need_products','max_times','single_user_once','upgrade','host_upgrade','renew','loop','cycle_limit','cycle','notes','on_demand_to_recurring_prepayment'],
        'status' => ['status'],
