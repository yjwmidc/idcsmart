...
return [
    ...
    'refund_on_demand_host_status_must_be_active_or_grace' => '停用产品仅状态为已激活或宽限期可操作',
    'refund_on_demand_settle_desc' => '用户停用产品:{host}',
    ...
    'refund_refund_on_demand_host' => '{client}停用产品:{host}',
