...
return [
    ...
    'refund_on_demand_host_status_must_be_active_or_grace' => 'Refund products can only be operated if their status is activated or during the grace period',
    'refund_on_demand_settle_desc' => 'User deactivates product: {host}',
    ...
    'refund_refund_on_demand_host' => '{client} deactivate product:{host}',
