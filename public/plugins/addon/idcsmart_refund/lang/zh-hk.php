...
return [
    ...
    'refund_on_demand_host_status_must_be_active_or_grace' => '失效產品僅限狀態為已啟動或寬限期可操作',
    'refund_on_demand_settle_desc' => '使用者失效產品:{host}',
    ...
    'refund_refund_on_demand_host' => '{client}失效產品:{host}',
