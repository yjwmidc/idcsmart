...
class IdcsmartRenewModel extends Model
{
    ...
    # 处理可续费周期(过滤规则)
    public function cyclesFilter(HostModel $host,$cycles,$promoCode='',$duration='')
    {
    ...
    public function renew($param)
    {
        ...
        $cycles = $this->cyclesFilter($host,$cycles,$param['customfield']['promo_code']??'',$duration??'');
