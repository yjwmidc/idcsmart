...
Route::group(env('DIR_ADMIN', 'admin') . '/v1',function (){
    ...
    Route::put('news/:id/top', "\\addon\\idcsmart_news\\controller\\AdminIndexController@topIdcsmartNews")
        ->append(['_plugin'=>'idcsmart_news','_controller'=>'admin_index','_action'=>'top_idcsmart_news']);
