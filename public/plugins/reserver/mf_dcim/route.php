...
Route::group('console/v1',function (){
	...
	Route::get('remf_dcim/:id/reinstall_status', "\\reserver\\mf_dcim\\controller\\home\\CloudController@getReinstallStatus");
	...
	Route::post('remf_dcim/:id/vnc/start', "\\reserver\\mf_dcim\\controller\\home\\CloudController@restartVnc");
	...
	Route::group('',function (){
		...
		Route::post('remf_dcim/:id/rescue/exit', "\\reserver\\mf_dcim\\controller\\home\\CloudController@exitRescue");
...
Route::group(env('DIR_ADMIN', 'admin') . '/v1',function (){
	...
	Route::group('', function (){
		...
		Route::post('remf_dcim/:id/rescue/exit', "\\reserver\\mf_dcim\\controller\\admin\\CloudController@exitRescue");
	...
	Route::post('remf_dcim/:id/vnc/start', "\\reserver\\mf_dcim\\controller\\admin\\CloudController@restartVnc");
