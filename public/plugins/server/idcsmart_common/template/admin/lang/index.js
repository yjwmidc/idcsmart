(function () {
  ...
  const module_lang = {
    "zh-cn": {
      ...
      drag_step: "拖动步长",
      drag_step_tip:
        "配置选项值范围内拖动时，每次拖动变化的数值。例：设置3，选项值拖动一次为加3或者减3",
      upgrade_tip: "允许升降级",
    },
    "zh-hk": {
      basic_config: "基礎配置",
      ...
      drag_step: "拖動步長",
      drag_step_tip:
        "配置選項值範圍內拖動時，每次拖動變化的數值。例：設置3，選項值拖動壹次為加3或者減3",
      upgrade_tip: "允許升降級",
    },
    "en-us": {
      ...
      com_tip5:
        "Supports HTML and will be displayed on the product configuration page. If you do not enter it, it will not be displayed. You can call js to implement custom restrictions and input for parameter calls.",
      ...
      mf_ratio_tip2:
        "For example: the period 'month' is set to 1, and the period 'year' is set to 10. Then the ratio of the price of 'month' to the price of 'year' in all periods of the product configuration item is 1:1",
      mf_ratio_tip3:
      ...
      drag_step_tip:
        "When dragging within the configuration option value range, the value that changes each time you drag. Example: If you set it to 3, the option value will increase or decrease by 3 after each drag",
      upgrade_tip: "Allow upgrade",
    },
  };
