...
Route::group('console/v1',function (){
    ...
    Route::post('idcsmart_common/batch_operate', "\\server\\idcsmart_common\\controller\\home\\IdcsmartCommonProductController@batchOperate");
    Route::get('idcsmart_common/batch_reinstall', "\\server\\idcsmart_common\\controller\\home\\IdcsmartCommonProductController@batchReinstallPage");
})->allowCrossDomain([
    'Access-Control-Allow-Origin'        => $origin,
    'Access-Control-Allow-Credentials'   => 'true',
    'Access-Control-Max-Age'             => 600,
...
Route::group(env('DIR_ADMIN', 'admin') . '/v1',function (){
    ...
    Route::put('idcsmart_common/product/:product_id/configoption/:id/upgrade', "\\server\\idcsmart_common\\controller\\admin\\IdcsmartCommonProductConfigoptionController@upgrade");
