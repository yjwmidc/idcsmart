...
class IdcsmartCommonProductConfigoptionController extends BaseController
{
     ...
     * @title 配置项是否支持升降级
     * @desc 配置项是否支持升降级
     * @url /admin/v1/idcsmart_common/product/:product_id/configoption/:id/upgrade
     * @method  put
     * @author wyh
     * @version v1
     * @param   int product_id - 商品ID require
     * @param   int id - 配置项ID require
     * @param   int upgrade - 是否支持升降级:1是，0否 require
     */
    public function upgrade()
    {
        ...
        $result = $IdcsmartCommonProductConfigoptionModel->upgradeConfigoption($param);
