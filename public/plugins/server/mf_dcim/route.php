...
Route::group('console/v1',function (){
	...
	Route::get('mf_dcim/:id/reinstall_status', "\\server\\mf_dcim\\controller\\home\\CloudController@getReinstallStatus");
	...
	Route::post('mf_dcim/:id/vnc/restart', "\\server\\mf_dcim\\controller\\home\\CloudController@restartVnc");
	...
	Route::group('',function (){
		...
		Route::post('mf_dcim/:id/rescue/exit', "\\server\\mf_dcim\\controller\\home\\CloudController@exitRescue");
...
Route::group(env('DIR_ADMIN', 'admin') . '/v1',function (){
	...
	Route::get('mf_dcim/:id/remote_info', "\\server\\mf_dcim\\controller\\admin\\CloudController@remoteInfo");
	...
	Route::group('', function (){
		...
		Route::post('mf_dcim/:id/rescue/exit', "\\server\\mf_dcim\\controller\\admin\\CloudController@exitRescue");
	...
	Route::post('mf_dcim/:id/vnc/restart', "\\server\\mf_dcim\\controller\\admin\\CloudController@restartVnc");
