...
class MfDcim
{
    ...
    {
		return ['display_name'=>'DCIM(自定义配置)', 'version'=>'3.0.2'];
	}
  ...
  `level_discount_bw_order` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '带宽是否应用等级优惠订购(0=关闭,1=开启)',
  `level_discount_ip_num_order` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT 'IP是否应用等级优惠订购(0=关闭,1=开启)',
  PRIMARY KEY (`id`),
