(function () {
  const module_lang = {
    "zh-cn": {
      ...
      ip_down_tip1: "剩余还需选择",
      ip_down_tip2:
        "个。选中的IP将被移除，移除后不可恢复。若不选IP则随机删除。",
    ...
    "en-us": {
      ...
      in_rescue_system: "In rescue system",
      defense_tip:
      ...
      ip_down_tip2:
        "The selected IP will be removed and cannot be restored after removal. If you do not select an IP, it will be deleted randomly.",
      ip_down_tip3:
        "Please select the corresponding number of IPs required for the downgrade operation.",
    },
    "zh-hk": {
      fixed_model: "固定機型",
      flexible_model: "靈活型號",
      ...
      ip_down_tip1: "剩餘還需選擇",
      ip_down_tip2:
        "個。選取的IP將會移除，移除後不可恢復。若不選IP則隨機刪除。",
