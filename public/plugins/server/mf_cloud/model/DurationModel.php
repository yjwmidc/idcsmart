...
//                ];
        ...
        if(!empty($onDemand)){
            foreach($preview as $k=>$v){
                ...
                // if($canDiscount){
                //     echo $v['key'] ?? '',"可以折扣:",$v['price'],PHP_EOL;
                // }
                ...
                if($canDiscount){
                    ...
                    //     }else{
                    //         $discountRenewPrice = bcadd($discountRenewPrice, $v['price'], 4);
                    //     }
                    // }else{
                    //     $discountRenewPrice = bcadd($discountRenewPrice, $v['price'], 4);
                    // }
        ...
        if(!empty($clientLevel)){
            ...
            // }else{
                $renewDiscount = bcdiv($renewPrice*$clientLevel['discount_percent'], 100, 4);
            // }
