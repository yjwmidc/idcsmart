...
class LineModel extends Model
{
    ...
    public function lineCreate($param): array
    {
        ...
        $this->startTrans();
        try{
            $line = $this->create($param, ['data_center_id','name','bill_type','bw_ip_group','defence_enable','defence_ip_group','ip_enable','link_clone','order','create_time','ipv6_enable','sync_firewall_rule','support_on_demand']);
