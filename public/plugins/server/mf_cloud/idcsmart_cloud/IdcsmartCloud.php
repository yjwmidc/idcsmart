...
class IdcsmartCloud{
	 ...
	 * @param   array param 请求参数
	 */
	public function flowData(int $id, $param){
		return $this->request('clouds/'.$id.'/flow_data', $param, 'GET');
	}
	 ...
	 */
	public function cloudFlow($id, $param = [])
	{
		return $this->request('clouds/'. $id .'/flow', $param, 'GET');
	}
	 ...
	 * @param   array param - 参数 require
	 */
	public function updateFlowSetting($id, $param = [])
	{
		return $this->request('clouds/'. $id .'/flow_setting', $param, 'PUT');
	}
