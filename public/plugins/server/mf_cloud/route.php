...
Route::group('console/v1',function (){
	...
	Route::get('mf_cloud/:id/flow_data', "\\server\\mf_cloud\\controller\\home\\CloudController@flowData");
...
# 后台,可登录不可登录的接口
Route::group(env('DIR_ADMIN', 'admin') . '/v1',function (){
...
Route::group(env('DIR_ADMIN', 'admin') . '/v1',function (){
	...
	Route::post('mf_cloud/line/:id/line_flow_on_demand', "\\server\\mf_cloud\\controller\\admin\\LineController@lineFlowOnDemandCreate");
	Route::get('mf_cloud/line_flow_on_demand/:id', "\\server\\mf_cloud\\controller\\admin\\LineController@lineFlowOnDemandIndex");
	Route::put('mf_cloud/line_flow_on_demand/:id', "\\server\\mf_cloud\\controller\\admin\\LineController@lineFlowOnDemandUpdate");
	Route::delete('mf_cloud/line_flow_on_demand/:id', "\\server\\mf_cloud\\controller\\admin\\LineController@lineFlowOnDemandDelete");
...
// Route::get(env('DIR_ADMIN', 'admin') . '/v1/mf_cloud/:id/vnc', "\\server\\mf_cloud\\controller\\admin\\CloudController@vncPage");