<?php /*a:3:{s:45:"../public/hcydxoep/template/default/oauth.php";i:1756623755;s:46:"../public/hcydxoep/template/default/header.php";i:1756623755;s:46:"../public/hcydxoep/template/default/footer.php";i:1756623755;}*/ ?>
<!DOCTYPE html>
  ...
  <com-config>
    <t-card class="list-card-container">
      <div class="common-header">
        <t-button @click="addUser" class="add" v-permission="'auth_system_configuration_oauth_get_more_interfaces'">
          {{lang.get_more}}
        </t-button>
      </div>
      <t-table row-key="id" :data="data" size="medium" :columns="columns" :hover="hover" :loading="loading"
        table-layout="auto" :hide-sort-tips="hideSortTips">
...
<script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/js/oauth.js"></script>
<!-- footer -->
