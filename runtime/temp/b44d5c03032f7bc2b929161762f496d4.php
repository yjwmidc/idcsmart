<?php /*a:1:{s:117:"/mnt/sdc/Webs/zjmf-v10-console/public/plugins/server/idcsmart_common/template/clientarea/pc/default/product_list.html";i:1756623758;}*/ ?>
<!-- 页面独有样式 -->
<!-- 通用产品 -->
<link rel="stylesheet"
  href="/plugins/server/idcsmart_common/template/clientarea/pc/default/css/common_product_list.css">
  ...
  <div class="main-card">
    ...
    <div class="main-card-table">
      ...
      <div class="main-card-search">
        <batch-renewpage :tab="params.tab" :ids="multipleSelection" module-type="idcsmart_common" @success="inputChange"
          ref="batchRenewRef">
        </batch-renewpage>
        <div class="right-search">
          <!-- 产品状态 -->
          <el-select v-model="params.status" style="width:3.2rem;" clearable @change="getList"
      ...
      <div class="table">
        <el-table v-loading="loading" :data="commonList" style="width: 100%;margin-bottom: .2rem;"
          ...
          @row-click="($event, event)=>toDetail($event, event)">
...
<script src="/plugins/server/idcsmart_common/template/clientarea/pc/default/js/common_product_list.js"></script>
