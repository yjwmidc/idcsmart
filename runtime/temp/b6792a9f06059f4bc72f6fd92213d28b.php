<?php /*a:3:{s:52:"../public/clientarea/template/pc/default/account.php";i:1756623755;s:51:"../public/clientarea/template/pc/default/header.php";i:1756623755;s:51:"../public/clientarea/template/pc/default/footer.php";i:1756623755;}*/ ?>
<!DOCTYPE html>
...
<!-- 页面独有样式 -->
<link rel="stylesheet" href="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/css/account.css">
<link rel="stylesheet" href="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/css/certification.css">
</head>
...
<body>
                ...
                <el-tab-pane :label="lang.account_menu1" name="1" v-if="showAccountController">
                  <div class="box-top">
                    <div class="right-name">
                      ...
                      <?php foreach($addons as $addon): if(($addon['name']=='IdcsmartCertification')): $PluginModel=new
                      app\admin\model\PluginModel();$config=$PluginModel->where('name','IdcsmartCertification')->value('config');$config=json_decode($config,true); if((isset($config['certification_open']) && $config['certification_open'])): ?>
                      <div class="attestation-status" v-show="attestationStatusInfo.iocnShow"
                        @click="handelAttestation(<?php echo htmlentities($addon['id']); ?>)">
  ...
  <script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/api/account.js"></script>
  <script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/api/certification.js"></script>
  ...
  <script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/js/account.js"></script>
