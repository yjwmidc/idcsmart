<?php /*a:3:{s:46:"../public/hcydxoep/template/default/plugin.php";i:1756623755;s:46:"../public/hcydxoep/template/default/header.php";i:1756623755;s:46:"../public/hcydxoep/template/default/footer.php";i:1756623755;}*/ ?>
<!DOCTYPE html>
...
<!-- =======内容区域======= -->
<link rel="stylesheet" href="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/css/addon.css">
<!-- =======内容区域======= -->
  ...
  <com-config>
    <t-card class="list-card-container">
        ...
        <div class="top-btn">
          <div class="left">
            ...
            <t-badge dot :count="1" v-if="isNeedUpgrade && $checkPermission('auth_app_list_sync_app')">
              <t-button theme="default" class="com-gray-btn" @click="getSystem" :loading="btnLoading">{{lang.sync_plugin}}</t-button>
            </t-badge>
      ...
      <t-table row-key="id" :data="filterPluginList" size="medium" :columns="columns" :hover="hover" :loading="loading"
        ...
        <template #status="{row}">
          <t-tag theme="primary" class="com-status" v-if="row.status === 1" variant="light">{{lang.enable}}</t-tag>
...
<script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/api/addon.js"></script>
<script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/js/addon.js"></script>
<!-- footer -->
