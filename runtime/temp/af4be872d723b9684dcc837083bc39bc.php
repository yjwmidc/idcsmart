<?php /*a:3:{s:62:"../public/hcydxoep/template/default/configuration_currency.php";i:1756623755;s:46:"../public/hcydxoep/template/default/header.php";i:1756623755;s:46:"../public/hcydxoep/template/default/footer.php";i:1756623755;}*/ ?>
<!DOCTYPE html>
    ...
    <t-card class="list-card-container">
      ...
      <div class="box">
        <t-form :data="formData" :rules="rules" :label-width="80" label-align="top" ref="formValidatorStatus"
          @submit="onSubmit">
          <p class="com-inner-title"><span>{{ lang.currency_setting }}</span></p>
          <t-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32, xl: 32, xxl: 60 }" class="custom-row">
            <t-col :xs="12" :xl="4" :md="6">
          ...
          <p class="com-tit"><span>{{ lang.balance_notice }}</span></p>


          <t-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32, xl: 32, xxl: 60 }" class="custom-row">
            <t-col :xs="12" :xl="4" :md="6">
              <t-form-item name="recharge_open" :label="lang.balance_notice_tip">
                <t-switch size="large" :custom-value="[1,0]" v-model="formData.balance_notice_show"></t-switch>
              </t-form-item>
            </t-col>
          </t-row>
          ...
          <t-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32, xl: 32, xxl: 60 }" class="custom-row">
            <t-col :xs="12" :xl="4" :md="6">
              <t-form-item name="recharge_open" :label="lang.recharge_open">
                <t-switch size="large" :custom-value="[1,0]" v-model="formData.recharge_open"></t-switch>
          ...
          <div class="recharge-notice">
            ...
            <t-switch size="large" :custom-value="[1,0]" v-model="formData.recharge_notice"></t-switch>
          </div>
          <div v-show="formData.recharge_notice == 1">
            <t-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32, xl: 32, xxl: 60 }" class="custom-row">
              <t-col :xs="12" :xl="12" :md="12">
                <t-form-item :label="lang.recharge_money_notice">
                  <t-textarea v-model="formData.recharge_money_notice_content" :placeholder="lang.tem_tip5"
                    :autosize="{ minRows: 5 }">
                  </t-textarea>
                </t-form-item>
              </t-col>
            ...
            <t-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32, xl: 32, xxl: 60 }" class="custom-row">
              <t-col :xs="12" :xl="12" :md="12">
                <t-form-item :label="lang.recharge_pay_notice">
                  <t-textarea v-model="formData.recharge_pay_notice_content" :placeholder="lang.tem_tip5"
                    :autosize="{ minRows: 5 }">
                  </t-textarea>
                </t-form-item>
              </t-col>
          ...
          <div class="com-is-fixed broaden" :class="{'has-shadow': !footerInView}">
            <t-button theme="primary" type="submit" :loading="submitLoading"
              v-permission="'auth_system_configuration_currency_configuration_save_configuration'">{{lang.hold}}</t-button>
...
<script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/js/configuration_currency.js"></script>
<!-- footer -->
