<?php /*a:2:{s:51:"../public/clientarea/template/pc/default/header.php";i:1756623755;s:80:"../public/plugins/addon/idcsmart_news/template/clientarea/pc/default/source.html";i:1756623756;}*/ ?>
<!-- 页面独有样式 -->
...
<body>
    ...
    <el-container>
      ...
      <el-container>
        ...
        <el-main>
          <!-- 自己的东西 -->
          <div class="main-card">
            <div class="main-card-title">{{lang.news_text11}}</div>

            <el-input v-model="params.keywords" class="search-input" :placeholder="lang.news_text12"
            ...
            <img class="back-img"
              src="/plugins/addon/idcsmart_news/template/clientarea/pc/default/img/source/source_back.png">
            <el-tabs v-model="activeIndex" @tab-click="handleClick">
              <?php foreach($addons as $addon): if($addon['name']=='IdcsmartHelp'): ?>
              <el-tab-pane ref="help" id="<?php echo htmlentities($addon['id']); ?>" :label="lang.news_text13" name="1">
              </el-tab-pane>
              <?php elseif($addon['name']=='IdcsmartNews'): ?>
              <el-tab-pane ref="news" id="<?php echo htmlentities($addon['id']); ?>" :label="lang.news_text14" name="2">
                <!-- pc端 -->
                <div class="box pc">
                  <div class="com-r-box">
                    <div class="tit">{{lang.news_text2}}</div>
                    <p class="total" @click="getAllnews" :class="{active:curId == ''}">
                      <span>{{lang.news_text5}}</span>
                    ...
                    <div class="file_folder">
                      <p class="item" v-for="(item,index) in folder" :key="item.id" :class="{active:curId === item.id}"
                        ...
                        {{item.name}}
                        <span class="tag"
                          :class="{suc: index % 4 === 0 ,war: index % 4 === 1,error: index  % 4 === 2, def: index % 4 === 3}">
              ...
              <?php elseif($addon['name']=='IdcsmartFileDownload'): ?>
              <el-tab-pane ref="download" id="<?php echo htmlentities($addon['id']); ?>" :label="lang.news_text15" name="3">
              </el-tab-pane>
              <?php endif; ?>
              <?php endforeach; ?>
            </el-tabs>
  ...
  <script src="/plugins/addon/idcsmart_news/template/clientarea/pc/default/js/news.js"></script>
