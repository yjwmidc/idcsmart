<?php /*a:2:{s:51:"../public/clientarea/template/pc/default/header.php";i:1756623755;s:104:"../public/plugins/addon/idcsmart_certification/template/clientarea/pc/default/authentication_select.html";i:1756623755;}*/ ?>
<!-- 页面独有样式 -->
<link rel="stylesheet"
                ...
                <div class="check-select">
                  ...
                  <div class="config-tip" v-if="configInfo.order && configInfo.order.status === 'Paid'">
                    {{lang.realname_text83}}<span
                      ...
                      style="color: var(--color-success);">({{lang.realname_text85}})</span>
                  </div>
                </div>
              </div>
              <div class="next-box">
