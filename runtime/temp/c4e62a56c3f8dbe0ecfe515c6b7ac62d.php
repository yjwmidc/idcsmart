<?php /*a:3:{s:59:"../public/hcydxoep/template/default/configuration_debug.php";i:1756623755;s:46:"../public/hcydxoep/template/default/header.php";i:1756623755;s:46:"../public/hcydxoep/template/default/footer.php";i:1756623755;}*/ ?>
<!DOCTYPE html>
      ...
      <div class="box">
        <t-form :data="formData" :label-width="80" label-align="top" ref="formValidatorStatus">
          <t-form-item :label="lang.debug_setting">
            <t-switch size="large" :custom-value="[1,0]" v-model="formData.debug_model" @change="changeSwitch"></t-switch>
...
<script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/js/configuration_debug.js"></script>
<!-- footer -->
