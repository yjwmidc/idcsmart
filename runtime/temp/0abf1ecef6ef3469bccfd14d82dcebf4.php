<?php /*a:3:{s:52:"../public/hcydxoep/template/default/server_group.php";i:1756623755;s:46:"../public/hcydxoep/template/default/header.php";i:1756623755;s:46:"../public/hcydxoep/template/default/footer.php";i:1756623755;}*/ ?>
<!DOCTYPE html>
    ...
    <t-dialog :visible.sync="visible" :header="title" :on-close="close" :footer="false" width="600">
      <t-form :rules="rules" :data="formData" ref="userDialog" @submit="onSubmit" v-if="visible">
        ...
        <t-form-item :label="lang.interface" name="server_id">
          <t-select v-model="formData.server_id" :placeholder="lang.interface" multiple
            :min-collapsed-num="1" :popup-props="popupProps" filterable>
...
<script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/js/server_group.js"></script>
<!-- footer -->
