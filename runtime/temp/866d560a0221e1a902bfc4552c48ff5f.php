<?php /*a:3:{s:52:"../public/clientarea/template/pc/default/finance.php";i:1756623755;s:51:"../public/clientarea/template/pc/default/header.php";i:1756623755;s:51:"../public/clientarea/template/pc/default/footer.php";i:1756623755;}*/ ?>
<!DOCTYPE html>
...
<!-- 页面独有样式 -->
<link rel="stylesheet" href="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/css/finance.css">
<link rel="stylesheet" href="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/css/voucher.css">
</head>
...
<body>
                    ...
                    <div class="content_table">
                      <div class="content_searchbar">
                        <div class="left_tips">
                          ...
                          <el-button size="mini" type="danger" @click="handelAllDel">{{lang.batch_delete}}
                          </el-button>
                        ...
                        <div class="searchbar com-search">
                          ...
                          <el-select v-model="params1.status" style="width: 1.5rem;margin-left: .2rem;" clearable
                      ...
                      <div class="mobel">
                        ...
                        <img v-show="isShowBackTop" class="back-top-img" @click="goBackTop"
                          src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/img/common/toTop.png">
                      </div>
                                ...
                                <div class="r-item">
                                  ...
                                  <div class="bot">
                                    <p class="more" :class="{active: item.isShow}" @click="toggleCoin(item)">
                                      {{lang.voucher_rule}}
                                      <img src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/img/voucher/check.png" alt="">
                                    </p>
                                  ...
                                  <p v-if="item.product?.length > 0">
                                    ...
                                    <span v-for="(el,index) in item.product" :key="el.id">
                                      <a :href="`/cart/goods.htm?id=${el.id}`" target="_blank"
                                        style="color: var(--base-color-primary);text-decoration: underline;">{{el.name}}</a>
                            ...
                            <template slot-scope="scope">
                              <div style="display: flex; align-items: center;">
                                ...
                                <img v-if="scope.row.status === 'complete' && scope.row.post_number" class="help-icon"
                                  ...
                                  src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/img/finance/icon_1.png"
  ...
  <script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/js/finance.js"></script>
  ...
  <script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/components/withdrawDialog/withdrawDialog.js"></script>
