<?php /*a:3:{s:51:"../public/hcydxoep/template/default/client_host.php";i:1755667656;s:46:"../public/hcydxoep/template/default/header.php";i:1755667656;s:46:"../public/hcydxoep/template/default/footer.php";i:1755667656;}*/ ?>
<!DOCTYPE html>
...
<!-- =======内容区域======= -->
<div id="content" class="host client-host hasCrumb" v-cloak>
  <com-config>
    <!-- crumb -->
    <div class="com-crumb">
    ...
    <t-card class="list-card-container">
      ...
      <div class="common-header">
        <div class="flex">
          ...
          <t-button theme="danger" @click="batchDel" class="add"
        ...
        <div class="right-search" style="margin-top: 0;">
          ...
          <t-button @click="changeAdvance" style="margin-left: 20px;" theme="primary" variant="outline">
      ...
      <div class="advanced" v-show="isAdvance">
        <div class="search">
          ...
          <com-tree-select :value="params.product_id" @choosepro="choosePro" class="search-input" :autowidth="true"
            :multiple="true" style="width: auto;"></com-tree-select>
...
<script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/js/client_host.js"></script>
<!-- footer -->
