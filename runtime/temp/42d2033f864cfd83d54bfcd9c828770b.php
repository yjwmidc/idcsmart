<?php /*a:3:{s:51:"../public/clientarea/template/pc/default/header.php";i:1756623755;s:51:"../public/clientarea/template/pc/default/footer.php";i:1756623755;s:48:"../public/cart/template/pc/default/goodsList.php";i:1756623755;}*/ ?>
<!-- 页面独有样式 -->
<link rel="stylesheet" href="/<?php echo htmlentities($template_catalog_cart); ?>/template/<?php echo htmlentities($themes_cart); ?>/css/goodsList.css">
</head>
...
<body>
                        ...
                        <div class="goods-content">
                          ...
                          <div class="goods-name" :class="{'sold-out':item.stock_control === 1 && item.qty <= 0}">
                            ...
                            <div class="qty-box" v-if="item.stock_control === 1">
                              ...
                              <img src="/<?php echo htmlentities($template_catalog_cart); ?>/template/<?php echo htmlentities($themes_cart); ?>/img/sold_out.svg" alt=""
                                v-else>
                            </div>
                          </div>
                        ...
                        <div class="domain-one" v-if="regType === '1'">
                          ...
                          <template v-else>
                            ...
                            <div class="start-search" v-loading="isSearching">
                              <img src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/img/goodsList/search_domain.png" alt="">
                          ...
                          <div class="batch-main">
                            ...
                            <template v-else>
                              ...
                              <div class="batch-search" v-loading="batchLoading">
                                <img src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/img/goodsList/search_domain.png"
                                  alt="">
  ...
  <!-- =======页面独有======= -->
  <script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/components/scrollText/scrollText.js"></script>
  <script src="/<?php echo htmlentities($template_catalog_cart); ?>/template/<?php echo htmlentities($themes_cart); ?>/api/goodsList.js"></script>
  <script src="/<?php echo htmlentities($template_catalog_cart); ?>/template/<?php echo htmlentities($themes_cart); ?>/js/goodsList.js"></script>
  <script src="/<?php echo htmlentities($template_catalog_cart); ?>/template/<?php echo htmlentities($themes_cart); ?>/api/product.js"></script>
