<?php /*a:3:{s:44:"../public/hcydxoep/template/default/task.php";i:1756623755;s:46:"../public/hcydxoep/template/default/header.php";i:1756623755;s:46:"../public/hcydxoep/template/default/footer.php";i:1756623755;}*/ ?>
<!DOCTYPE html>
...
<!-- =======内容区域======= -->
<link rel="stylesheet" href="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/css/manage.css">
        ...
        <t-form :data="formData" ref="form" @submit="onSubmit" layout="inline" label-align="left">
          ...
          <t-form-item>
            <t-date-range-picker allow-input clearable v-model="range"
              :placeholder="[`${lang.select}${lang.client_care_label44}`,`${lang.select}${lang.client_care_label44}`]">
            </t-date-range-picker>
          </t-form-item>
          <t-form-item class="f-btn">
            <t-button theme="primary" type="submit">{{lang.query}}</t-button>
            <t-button theme="default" class="com-gray-btn" variant="base" @click="reset">{{lang.reset}}</t-button>
          </t-form-item>
        </t-form>
      </div>
...
<script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/js/task.js"></script>
<!-- footer -->
