<?php /*a:3:{s:49:"../public/clientarea/template/pc/default/home.php";i:1749055993;s:51:"../public/clientarea/template/pc/default/header.php";i:1749055993;s:51:"../public/clientarea/template/pc/default/footer.php";i:1749055993;}*/ ?>
<!DOCTYPE html>
...
<link rel="stylesheet" href="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/css/home.css">
</head>
...
<body>
              ...
              <div class="left-box">
                <div class="info-box">
                  ...
                  <div class="info-second" v-loading="nameLoading">
                    <div class="email-box">
                      <span><img src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/img/home/email-icon.png"
                          alt="">{{lang.index_email}}</span>
                      <span class="phone-number">{{account.email ? account.email : '--'}}</span>
                    </div>
                    <div class="phone-box">
                      <span><img src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/img/home/tel-icon.png"
                  ...
                  <div class="info-three" v-plugin="'IdcsmartCertification'"
                    ...
                    <div class="compny-box">
                      <div class="left-icon">
                        <img src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/img/home/compny-icon.png" alt="">
                        ...
                        <div class="certify-id">
                          ...
                          <div class="company-name certify-bottom" :title="certificationObj.company?.certify_id">
                            ...
                            <img class="cpoy-btn" v-copy="certificationObj.company.certify_id"
                              ...
                              src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/img/home/copy.svg" alt="">
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="person-box">
                      <div class="left-icon">
                        <img class="left-icon" src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/img/home/person-icon.png"
                          alt="">
                        ...
                        <div class="certify-id">
                          ...
                          <div class="company-name certify-bottom" :title="certificationObj.person?.certify_id">
                            ...
                            <img v-copy="certificationObj.person?.certify_id" v-if="certificationObj.person?.certify_id"
                              class="cpoy-btn" src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/img/home/copy.svg" alt="">
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="order-box">
                      <div class="order-item order-box-1">
                        <div class="order-type-img">
                          <img src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/img/home/activation-icon.png" alt="">
                        </div>
                      ...
                      <div class="order-item order-box-2">
                        <div class="order-type-img">
                          <img src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/img/home/prduct-icon.png" alt="">
                        </div>
                      ...
                      <div class="order-item order-box-3">
                        <div class="order-type-img">
                          <img src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/img/home/no-pay-order.png" alt="">
                        </div>
              ...
              <div class="right-box">
                ...
                <div class="recommend-box-open" v-if="showRight && isOpen" v-plugin="'IdcsmartRecommend'">
                  <div class="recommend-top">
                    <div class="left">
                      <div class="row1">
                        ...
                        <span class="reword" @click="toReferral"><img
                            src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/img/home/reword.png"
                    ...
                    <img class="right" src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/img/home/credit-card.png" alt="">
                  </div>
                  <div class="url">
                  ...
                  <div class="top-statistic">
                    <div class="top-item">
                      ...
                      <img class="top-img" src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/img/referral/top1.png" />
                    </div>
                    <div class="top-item">
                      <div class="item-top">
                      ...
                      <img class="top-img" src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/img/referral/top3.png" />
                    </div>
                  </div>
                </div>
                <div class="recommend-box" v-if="!showRight || !isOpen">
                  <img src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/img/home/recommend-img.png" alt="">
                  <div v-if="showRight">
  ...
  <!-- =======页面独有======= -->
  <script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/api/finance.js"></script>
  <script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/api/home.js"></script>
  <script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/js/home.js"></script>
