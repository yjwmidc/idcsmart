<?php /*a:2:{s:46:"../public/hcydxoep/template/default/header.php";i:1756623755;s:72:"../public/plugins/addon/idcsmart_file_download/template/admin/index.html";i:1756623755;}*/ ?>
  ...
  <com-config>
    <t-card class="list-card-container left-card">
      <div class="help_card">
        <div class="common-header top">
          <div class="tabs flex">
            <t-button @click="changetabs(1)"
              v-permission="'auth_site_management_file_download_upload_file'">
              {{lang.attachment}}
            </t-button>
            <t-button theme="default" @click="changetabs(2)" v-permission="'auth_site_management_file_download_move_file'">
              {{lang.file_move}}
            </t-button>
            <t-button theme="danger" @click="changetabs(3)"
              v-permission="'auth_site_management_file_download_delete_file'">
              {{lang.delete}}
            </t-button>
          </div>
          <div class="flex">
            ...
            <t-button @click="getfilelist(1)">{{lang.query}}</t-button>
          </div>
        </div>
        <div class="help_table">
          <t-table hover row-key='id' drag-sort="row-handler" @drag-sort="onDragSort" 
            :hide-sort-tips="true" :data="list" @sort-change="sortChange"
            ...
            <template #op="slotProps">
              <t-icon name="edit-1" class="common-look"
    ...
    <t-dialog :header="lang.attachment" placement="center" :visible.sync="visible" @Cancel="onCancel" :footer="false"
      ...
      <t-upload :action="uploadUrl" :format-response="formatResponse" :headers="uploadHeaders" @Change="changeupload"
        ...
        <t-button theme="primary" style="margin-bottom: 24px;" :loading="uploadLoading">{{lang.attachment_file}}</t-button>
        <!-- <span>{{uploadTip}}</span> -->
      </t-upload>
