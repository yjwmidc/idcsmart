<?php /*a:3:{s:52:"../public/hcydxoep/template/default/notice_email.php";i:1756623755;s:46:"../public/hcydxoep/template/default/header.php";i:1756623755;s:46:"../public/hcydxoep/template/default/footer.php";i:1756623755;}*/ ?>
<!DOCTYPE html>
    ...
    <t-card class="list-card-container">
      <div class="common-header top">
        <div class="flex">
          ...
          <t-button theme="default" @click="getMore" class="add com-gray-btn"
      ...
      <t-table row-key="id" :data="data" size="medium" :columns="columns" :hover="hover" :loading="loading"
        ...
        <template #status="{row}">
          ...
          <t-tag theme="danger" class="com-status" v-if="row.status===0" variant="light">{{lang.disable}}</t-tag>
...
<script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/js/notice_email.js"></script>
<!-- footer -->
