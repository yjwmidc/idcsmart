<?php /*a:1:{s:43:"../public/home/template/pc/default/home.php";i:1758278328;}*/ ?>
<link rel="stylesheet" href="/<?php echo htmlentities($template_catalog_home); ?>/template/<?php echo htmlentities($themes_home); ?>/css/home.css">
</head>
...
<body>
              ...
              <div class="left-box">
                <div class="info-box">
                  ...
                  <div class="info-second" v-loading="nameLoading">
                    <div class="email-box">
                      <span><img src="/<?php echo htmlentities($template_catalog_home); ?>/template/<?php echo htmlentities($themes); ?>/img/email-icon.png"
                          alt="">{{lang.index_email}}</span>
                      <span class="phone-number">{{account.email ? account.email : '--'}}</span>
                    </div>
                    <div class="phone-box">
                      <span><img src="/<?php echo htmlentities($template_catalog_home); ?>/template/<?php echo htmlentities($themes); ?>/img/tel-icon.png"
                  ...
                  <div class="info-three" v-plugin="'IdcsmartCertification'"
                    ...
                    <div class="compny-box">
                      <div class="left-icon">
                        <img src="/<?php echo htmlentities($template_catalog_home); ?>/template/<?php echo htmlentities($themes); ?>/img/compny-icon.png" alt="">
                        ...
                        <div class="certify-id" v-if="certificationObj.certification_show_certify_id === 1">
                          ...
                          <div class="company-name certify-bottom" :title="certificationObj.company?.certify_id">
                            ...
                            <img class="cpoy-btn" v-copy="certificationObj.company.certify_id"
                              ...
                              src="/<?php echo htmlentities($template_catalog_home); ?>/template/<?php echo htmlentities($themes); ?>/img/copy.svg" alt="">
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="person-box">
                      <div class="left-icon">
                        <img class="left-icon" src="/<?php echo htmlentities($template_catalog_home); ?>/template/<?php echo htmlentities($themes); ?>/img/person-icon.png"
                          alt="">
                        ...
                        <div class="certify-id" v-if="certificationObj.certification_show_certify_id === 1">
                          ...
                          <div class="company-name certify-bottom" :title="certificationObj.person?.certify_id">
                            ...
                            <img v-copy="certificationObj.person?.certify_id" v-if="certificationObj.person?.certify_id"
                              class="cpoy-btn" src="/<?php echo htmlentities($template_catalog_home); ?>/template/<?php echo htmlentities($themes); ?>/img/copy.svg" alt="">
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="order-box">
                      <div class="order-item order-box-1" @click="goProductList('using')">
                        <div class="order-type-img">
                          <img src="/<?php echo htmlentities($template_catalog_home); ?>/template/<?php echo htmlentities($themes); ?>/img/activation-icon.png" alt="">
                        </div>
                      ...
                      <div class="order-item order-box-2" @click="goProductList()">
                        <div class="order-type-img">
                          <img src="/<?php echo htmlentities($template_catalog_home); ?>/template/<?php echo htmlentities($themes); ?>/img/prduct-icon.png" alt="">
                        </div>
                      ...
                      <div class="order-item order-box-3" @click="goOrderList('Unpaid')">
                        <div class="order-type-img">
                          <img src="/<?php echo htmlentities($template_catalog_home); ?>/template/<?php echo htmlentities($themes); ?>/img/no-pay-order.png" alt="">
                        </div>
              ...
              <div class="right-box">
                ...
                <div class="recommend-box-open" v-if="showRight && isOpen" v-plugin="'IdcsmartRecommend'">
                  <div class="recommend-top">
                    <div class="left">
                      <div class="row1">
                        ...
                        <span class="reword" @click="toReferral"><img
                            src="/<?php echo htmlentities($template_catalog_home); ?>/template/<?php echo htmlentities($themes); ?>/img/reword.png"
                    ...
                    <img class="right" src="/<?php echo htmlentities($template_catalog_home); ?>/template/<?php echo htmlentities($themes); ?>/img/credit-card.png" alt="">
                  </div>
                  <div class="url">
                ...
                <div class="recommend-box" v-if="!showRight || !isOpen">
                  <img src="/<?php echo htmlentities($template_catalog_home); ?>/template/<?php echo htmlentities($themes); ?>/img/recommend-img.png" alt="">
                  <div v-if="showRight">
  ...
  <!-- =======页面独有======= -->
  <script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/components/creditNotice/creditNotice.js"></script>
  ...
  <script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/components/rechargeDialog/rechargeDialog.js"></script>
  <script src="/<?php echo htmlentities($template_catalog_home); ?>/template/<?php echo htmlentities($themes_home); ?>/api/finance.js"></script>
  <script src="/<?php echo htmlentities($template_catalog_home); ?>/template/<?php echo htmlentities($themes_home); ?>/api/home.js"></script>
  <script src="/<?php echo htmlentities($template_catalog_home); ?>/template/<?php echo htmlentities($themes_home); ?>/js/home.js"></script>
