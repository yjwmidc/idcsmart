<?php /*a:3:{s:61:"../public/hcydxoep/template/default/configuration_upgrade.php";i:1756623755;s:46:"../public/hcydxoep/template/default/header.php";i:1756623755;s:46:"../public/hcydxoep/template/default/footer.php";i:1756623755;}*/ ?>
<!DOCTYPE html>
    ...
    <t-card class="list-card-container">
      ...
      <div class="upgrade-box">
        <div class="upgrade-contend">
          ...
          <t-table :data="newList" row-key="id" :columns="columns" hover="hover" table-layout="auto"
            :loading="isLoading" cellEmpty-content="-"
            @row-click="onRowClick" class="table-box">
          </t-table>
...
<script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/js/configuration_upgrade.js"></script>
