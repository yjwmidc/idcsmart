<?php /*a:3:{s:57:"../public/hcydxoep/template/default/configuration_oss.php";i:1755667656;s:46:"../public/hcydxoep/template/default/header.php";i:1755667656;s:46:"../public/hcydxoep/template/default/footer.php";i:1755667656;}*/ ?>
<!DOCTYPE html>
  ...
  <com-config>
        ...
        <t-table row-key="id" :data="data" :hover="true" :loading="loading" size="medium" :columns="columns"
          ...
          <template #title="{row}">
            <span style="display: flex; align-items: center; column-gap: 2px;">
              ...
              <img :src="`/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/img/real-1.svg`" alt="" v-if="row.link">
              <!-- </t-tooltip> -->
              <!-- <t-tooltip :content="lang.oss_text25" :show-arrow="false" theme="light"> -->
              <img :src="`/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/img/real-2.svg`" alt="" v-if="!row.link">
              <!-- </t-tooltip> -->
            </span>
          </template>
          <template #status="{row}">
            <t-tag theme="danger" variant="light" v-if="row.status == 0">{{lang.oss_text25}}</t-tag>
            <t-tag theme="primary" variant="light" v-if="row.status == 1">{{lang.oss_text9}}</t-tag>
            <t-tag theme="default" variant="light" v-if="row.status == 3">{{lang.oss_text26}}</t-tag>
          </template>
          <template #have="{row}">
        ...
        <div class="oss-setting">
          ...
          <div class="oss-method">
            ...
            <t-tree-select style="width: 360px;" :label="lang.oss_text33 + ':'"
              v-model="ossPageData.oss_sms_plugin_admin" :data="adminList" multiple :min-collapsed-num="1" clearable
          ...
          <div class="oss-method">
            ...
            <t-tree-select style="width: 360px;" :label="lang.oss_text33 + ':'"
              v-model="ossPageData.oss_mail_plugin_admin" :data="adminList" multiple :min-collapsed-num="1" clearable
              :placeholder="lang.oss_text33" :tree-props="treeProps">
            </t-tree-select>
          </div>
        </div>
    ...
    <t-dialog :header="false" :visible.sync="localVisible" :footer="false" width="520">
      <div class="oss-dia-change">
        <div class="left-icon">
          <img src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/img/oss-warning.svg" alt="">
        </div>
...
<script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/js/configuration_oss.js"></script>
