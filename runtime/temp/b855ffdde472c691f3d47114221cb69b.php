<?php /*a:3:{s:62:"../public/hcydxoep/template/default/configuration_security.php";i:1756623755;s:46:"../public/hcydxoep/template/default/header.php";i:1756623755;s:46:"../public/hcydxoep/template/default/footer.php";i:1756623755;}*/ ?>
<!DOCTYPE html>
      ...
      <div class="box">
        <t-form :data="formData" :label-width="80" label-align="top" :rules="rules" ref="formValidatorStatus"
          ...
          <t-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32, xl: 32, xxl: 60 }">
            ...
            <t-col>
              <t-form-item :label="lang.error_choose_code_admin">
                <t-radio-group v-model="formData.captcha_admin_login_error" :disabled="!formData.captcha_admin_login">
                  <t-radio value="0">{{lang.always_show}}</t-radio>
                  <t-radio value="1">{{lang.fail_three_show}}</t-radio>
                </t-radio-group>
              </t-form-item>
          ...
          <div class="tip" style="margin-top: var(--td-comp-margin-xxl);">
            <t-icon name="error-circle" size="18"></t-icon>
            <div>
              <p>{{lang.tip3}}</p>
              <p>{{lang.tip4}}</p>
...
<script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/js/configuration_security.js"></script>
<!-- footer -->
