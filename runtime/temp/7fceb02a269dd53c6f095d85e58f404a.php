<?php /*a:3:{s:59:"../public/hcydxoep/template/default/configuration_login.php";i:1756623755;s:46:"../public/hcydxoep/template/default/header.php";i:1756623755;s:46:"../public/hcydxoep/template/default/footer.php";i:1756623755;}*/ ?>
<!DOCTYPE html>
                  ...
                  <t-col :xs="24" :xl="12" :md="12">
                    <t-form-item name="admin_login_ip_whitelist">
                      <div slot="label" class="custom-label">
                        ...
                        <t-tooltip placement="top-right" :content="lang.admin_login_ip_whitelist_tip" :show-arrow="false"
                          theme="light">
                          <t-icon name="help-circle" size="18px" />
                        </t-tooltip>
                      </div>
                      <t-textarea 
                        v-model="formData.admin_login_ip_whitelist"
                        :placeholder="lang.admin_login_ip_whitelist_placeholder"
                        :rows="5"
                        :maxlength="2000">
                      </t-textarea>
                    </t-form-item>
...
<script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/js/configuration_login.js"></script>
<!-- footer -->
