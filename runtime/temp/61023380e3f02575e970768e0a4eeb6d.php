<?php /*a:3:{s:46:"../public/hcydxoep/template/default/server.php";i:1756623755;s:46:"../public/hcydxoep/template/default/header.php";i:1756623755;s:46:"../public/hcydxoep/template/default/footer.php";i:1756623755;}*/ ?>
<!DOCTYPE html>
  ...
  <com-config>
    <t-card class="list-card-container">
      <div class="common-header">
        <div class="l-btn">
          ...
          <t-button @click="toChild" theme="default" class="add com-gray-btn"
      ...
      <t-table row-key="id" :data="data" size="medium" :columns="columns" :hover="hover" :loading="loading"
        ...
        <template #status="{row}">
          <t-tag theme="primary" class="status" v-if="row.status" variant="light">{{lang.enable}}</t-tag>
    ...
    <t-dialog :visible.sync="visible" :header="title" :on-close="close" :footer="false" width="600">
      <t-form :rules="rules" :data="formData" ref="userDialog" @submit="onSubmit" v-if="visible">
        ...
        <t-form-item :label="lang.has_interface" name="has_interface" v-if="formData.module === 'idcsmart_common'">
          <t-radio-group v-model="formData.has_interface">
            <t-radio :value="0">{{lang.has_interface_no}}</t-radio>
            <t-radio :value="1">{{lang.has_interface_yes}}</t-radio>
          </t-radio-group>
        </t-form-item>

        <template v-if="!(formData.module === 'idcsmart_common' && formData.has_interface === 0)">
          ...
          <input type="text" class="com-empty-input">
          <input type="password" class="com-empty-input">
...
<script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/js/server.js"></script>
<!-- footer -->
