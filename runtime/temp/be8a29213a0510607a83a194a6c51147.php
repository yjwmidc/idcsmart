<?php /*a:3:{s:51:"../public/clientarea/template/pc/default/header.php";i:1756623755;s:51:"../public/clientarea/template/pc/default/footer.php";i:1756623755;s:44:"../public/cart/template/pc/default/goods.php";i:1756623755;}*/ ?>
<script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/js/common/jquery.mini.js"></script>
<link rel="stylesheet" href="/<?php echo htmlentities($template_catalog_cart); ?>/template/<?php echo htmlentities($themes_cart); ?>/css/goods.css">
</head>
...
<body>
  ...
  <script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/components/eventCode/eventCode.js"></script>
  <script src="/<?php echo htmlentities($template_catalog); ?>/template/<?php echo htmlentities($themes); ?>/components/customGoods/customGoods.js"></script>
  <script src="/<?php echo htmlentities($template_catalog_cart); ?>/template/<?php echo htmlentities($themes_cart); ?>/js/goods.js"></script>
