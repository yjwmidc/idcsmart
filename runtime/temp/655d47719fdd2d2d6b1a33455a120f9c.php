<?php /*a:2:{s:46:"../public/hcydxoep/template/default/header.php";i:1756623755;s:71:"../public/plugins/addon/idcsmart_announcement/template/admin/index.html";i:1756623755;}*/ ?>
        ...
        <div class="common-header flex">
          <div class="tabs flex">
            <t-button  @click="changetabs(1)"
              v-permission="'auth_site_management_announcement_create_announcement'">{{lang.order_new}}</t-button>
            <t-button theme="default" class="com-gray-btn" @click="changetabs(3)" v-permission="'auth_site_management_announcement_type'">
          ...
          <div class="flex">
            ...
            <t-button @click="onEnter">{{lang.query}}</t-button>
          </div>
        </div>
        <div class="help_table">
          <t-table hover row-key="index" :loading="loading" :data="list" :columns="columns" >
            ...
            <template #create_time="slotProps">
              <span v-if="slotProps.row.create_time">{{ getLocalTime(slotProps.row.create_time)
                }}</span>
            </template>
            <template #op="slotProps">
              <t-icon name="edit-1" color="#0052D9" @click="edit(slotProps.row.id)"
