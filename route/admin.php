...
# 应用商店
Route::post(env('DIR_ADMIN', 'admin').'/v1/app_market/check_token', 'admin/appMarket/checkToken'); # 校验token
Route::post(env('DIR_ADMIN', 'admin').'/v1/app_market/app/:id/install', 'admin/appMarket/install'); # 安装应用
...
Route::get(env('DIR_ADMIN', 'admin'),'admin/view/index')->middleware(app\http\middleware\CheckAdminCookieJwt::class); //模板首页
Route::get(env('DIR_ADMIN', 'admin').'/[:view_html]','admin/view/index')->ext('htm')->middleware(app\http\middleware\CheckAdminCookieJwt::class); //后台模板
Route::get(env('DIR_ADMIN', 'admin').'/plugin/[:name]/[:view_html]','admin/view/plugin')->ext('htm')->middleware(app\http\middleware\CheckAdminCookieJwt::class); //后台插件模板
Route::get(env('DIR_ADMIN', 'admin').'/template/[:name]/[:view_html]','admin/view/template')->ext('htm'); //后台模板控制器模板